...
function appenddata(data){
    ...
    for(var j = 0; j < data.length; j++){
        ...
        if(data[j].Name == document.getElementById("head").innerText){
    ...
    var mature = document.createElement("a");

    var linkText = document.createTextNode("Mature");
    mature.appendChild(linkText);
    mature.title = "Mature";
    mature.href = "private/" + data[i].Name;
    document.getElementById("tops").appendChild(mature);
    ...
    var each_upt = document.createElement('div');
        ...
        if(data[i].Website == "no"){
            chapter.innerHTML = "Chapter, This manhwa isn't available";
        }
        ...
        const each_data = "https://docs.google.com/spreadsheets/d/1R1e93BSQ-dVmHgZadcJmINP_qDJo65CZFBJ98hhzpvk/export?format=csv";
            ...
            function each(datae){
                ...
                for(var j = 0; j < datae.length; j++){
                    if(datae[j].Name == document.getElementById("head").innerText){
            ...
            function potra(datap){
                ...
                for(var i = 0; i < datap.length; i++){
                    if(datap[i].Name == document.getElementById("head").innerText){
