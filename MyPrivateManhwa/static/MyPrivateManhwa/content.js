...
function appenddata(data){
    ...
    function create(i){
        ...
        next.title = data[i].Name;
        next.href = data[i].Name;
        each_name.appendChild(next);
        //each_name.innerHTML = "<a href=\'" + data[i].Name + "\'>"+ data[i].Name + "</a>";
        ...
        if(window.innerWidth >= 1200){ // desktop version
            ...
            par.style.gridColumn = "1 / span 4"
            main.style.display = "grid";
            main.style.setProperty('grid-template-columns', 'repeat(4, 2fr)');
            main.style.gap = "20px";
