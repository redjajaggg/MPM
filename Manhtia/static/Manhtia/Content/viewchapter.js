...
function create(data, filter){
    ...
    var chapters = [];
    var descrips = [];
    fetch(`https://script.google.com/macros/s/AKfycbwcDe7zIvjY5p4rVQ-4mBIw3OCnI_ntnHhcKhmjGMGAgbB3ghnZ6MhVecVS1uHKWxD1Gw/exec?nm=${document.getElementById("nameget").innerText}&bm=${document.getElementById("chapterget").innerText}&tp=auto`)
...
function book_self(){
    fetch(`https://script.google.com/macros/s/AKfycbwcDe7zIvjY5p4rVQ-4mBIw3OCnI_ntnHhcKhmjGMGAgbB3ghnZ6MhVecVS1uHKWxD1Gw/exec?nm=${document.getElementById("nameget").innerText}&bm=${document.getElementById("chapterget").innerText}&tp=self`)
}
