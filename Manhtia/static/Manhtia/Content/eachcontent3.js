...
function appenddata(data){
    ...
    if(data[i].Website == "no"){
        document.getElementById("picture").innerHTML = "This manhwa has no chapter and will not update.";
    }
    ...
    function chapterpage(data, status, picture){
        ...
        link.title = data;
        link.href = "/manhtia/content/" + document.getElementById("nameget").innerText + "/" + data;
