...
function appenddata(data){
    ...
    three.innerHTML = "<label style='font-weight: bold;'>Number:</label> " + data[i].Number + " <label style='font-weight: bold;'>Date:</label> <label id='tendays'>" + covertdate(data[i].Date) + "</label>";
