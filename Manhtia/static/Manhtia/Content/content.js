    ...
    document.getElementById("content").innerHTML = "";
        ...
        if(value == "uptoday"){
            for(var i = 0; i < data_story.length; i++){
                ...
                if(data_story[i].Date == getday && data_story[i].Status != "end"){create(data_story, i);}//for weekly update
                ...
                if(data_story[i].Date == "n"){
                    ...
                    for(var j = 0; j < dates.length; j++){
                        if(dates[j].includes("UpdateEvery")){
                            ...
                            if((dates[j].includes(getdate) || dates[j].includes(getdate + 1) || dates[j].includes(getdate - 1)) && data_story[i].Status != "end"){
                                create(data_story, i);
                            }
        ...
        if(value == "upyesterday"){
            for(var i = 0; i < data_story.length; i++){
                ...
                if(getday - 1 == data_story[i].Date && data_story[i].Status != "end"){create(data_story, i);}
            }
        }
        if(value == "n"){
            for(var i = 0; i < data_story.length; i++){
