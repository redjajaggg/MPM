...
function filters(){
    ...
    if(value == "yes"){
        for(var i = 0; i < data_story.length; i++){
            if(data_story[i].Website == value){create_command(data_story, o);}
        }
    }
    if(value == "no"){
        for(var i = 0; i < data_story.length; i++){
    ...
    if(value == "ongoing"){
        for(var i = 0; i < data_story.length; i++){
            if(data_story[i].Status == value){create_command(data_story, o);}
        }
    }
    if(value == "end"){
        for(var i = 0; i < data_story.length; i++){
    ...
    if(value == "n"){
        for(var i = 0; i < data_story.length; i++){
            if(data_story[i].Date == value){create_command(data_story, o);}
        }
    }
    if(value == "1"){
        for(var i = 0; i < data_story.length; i++){
