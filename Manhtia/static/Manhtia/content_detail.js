...
function create(data, i){
  ...
  var newnewtokilink = document.getElementById('newtoki_todomain').innerHTML + newtokilink.substring(23);
  ...
  if(data[i].Rawwebsite != "n"){link1 = "<a class='modernlink' href='" + data[i].Rawwebsite + "'>(RawM)</a>"}
  if(data[i].Newtoki != "n"){link2 = "<a class='modernlink' href='" + newnewtokilink + "'>(RawL)</a>"}
  if(data[i].Englishwebsite != "n"){link3 = "<a class='modernlink' href='" + data[i].Englishwebsite + "'>(English)</a>"}
  ...
  var rate;
  if(data[i].Rate == "n"){rate = "All age";}
  if(data[i].Rate == "15"){rate = "R15";}
  if(data[i].Rate == "18"){rate = "R18";}
  if(data[i].AssName == "n"){data[i].AssName = "Unknown";}
  var national;
  if(data[i].Nation == "kr"){national = "<img src='https://i.pinimg.com/564x/26/16/8c/26168cddf75348cc28299de4daddcb5b.jpg' style='width: 30px;'>";}
  if(data[i].Nation == "cn"){national = "<img src='https://i.pinimg.com/564x/d0/96/c0/d096c0d511574bb41a18ed61deb5a06e.jpg' style='width: 30px;'>";}
  if(data[i].Nation == "th"){national = "<img src='https://i.pinimg.com/564x/ca/bc/d3/cabcd397c3831d374df02e52d127b9f1.jpg' style='width: 30px;'>";}
  var overall;
  if(data[i].Overall == "n"){overall = "Ongoing";}
  if(data[i].Overall == "c"){overall = "Completed";}
  var morelink1 = "";
  var morelink2 = "";
  var morelink3 = "";
  if(data[i].Morelink1 != "n"){morelink1 = "<a href='" + data[i].Morelink1 + "'>(Other I)</a>";}
  if(data[i].Morelink2 != "n"){morelink2 = "<a href='" + data[i].Morelink2 + "'>(Other II)</a>";}
  if(data[i].Morelink3 != "n"){morelink3 = "<a href='" + data[i].Morelink3 + "'>(Other III)</a>";}

  alte_div.innerHTML += morelink1 + morelink2 + morelink3 + "<br>Associate: " +  data[i].AssName + " " + national + "<br>Rate: " + rate + "<a href='https://www.google.com/search?q=" + data[i].Name.replaceAll(" ", "+").replaceAll("'", "") + "+spoiler'>(Spoiler)</a> " + "<a href='https://www.google.com/search?q=" + data[i].Name.replaceAll(" ", "+").replaceAll("'", "") + "+baka'>(Detail)</a>" + "<br>";
  alte_div.innerHTML += "Overall in Manhtia: " + overall;

  if(i % 5 == 0){part_div.innerHTML = "Part " + data[i].Part; document.getElementById("convey").appendChild(part_div); part_div.style.gridColumn = "1 / span 3"; part_div.style.marginLeft = "auto"; part_div.style.marginRight = "auto"; part_div.setAttribute("class", "moderndiv");}
  ...
  if(data[i].Website == true){more_div.appendChild(each_data);}
  each_data.onclick = () => {
  ...
  if(data[i].Website == true){name_div.appendChild(web_check);}
  if(data[i].Convey == false){main_div.innerHTML = data[i].Name + " <br>is Not Availiable.";}
  document.getElementById("convey").appendChild(main_div);
