...
function create(data, i, status){
    ...
    img.onclick = function (e) {
        ...
        document.getElementById("bigimage").style.width = "700px";
        document.getElementById("bigwidth").value = 700;
        document.getElementById("getwidth").innerHTML = "700";
...
document.getElementById("bigwidth").oninput = () => {
    document.getElementById("getwidth").innerHTML = document.getElementById("bigwidth").value;
    document.getElementById("bigimage").style.width = document.getElementById("bigwidth").value + "px";
}