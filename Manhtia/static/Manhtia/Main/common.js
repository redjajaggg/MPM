...
function korean_time(){
    ...
    document.getElementById("time").innerHTML = `
        <labeL style='font-weight: bold;'>S.Korea:</labeL> ${eastCoastTime} <label onclick="process('Almost Chapters will update 10.00PM everyday.')">(i)</label>
    `;
}
//getday in Korea function
