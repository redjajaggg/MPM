...
function create(data, i){
    ...
    //every 7 days
    if(getday_korea()[0] == data[i].Date && data[i].Status !== "end"){upd = "<img id='more_told' src='https://i.pinimg.com/564x/48/63/be/4863be978d4b93227aeb215e6bdf0739.jpg'>";}
    if(getday_korea()[0] - 1 == -1){getday_korea()[0] = 6;}
    if(getday_korea()[0] - 1 == data[i].Date && data[i].Status != "end"){upd = "<img id='more_told' src='https://i.pinimg.com/564x/22/04/cc/2204cc955737d2ec1d8250a5d10d248d.jpg'>";}
