...
/*function create(data, i){
    ...
    var specific_div = document.createElement("div");
    ...
    if(data[i].Date === getday.toString() && data[i].Status !== "end"){

        update_div.innerHTML = `
            <img src='https://i.pinimg.com/564x/48/63/be/4863be978d4b93227aeb215e6bdf0739.jpg' style='width: 20px; vertical-align: middle; border-radius: 5px;'> <label style='font-size: 10px;'>今晚更新</label>
        `;
    ...
    //append
    main_div.appendChild(update_div);
...
function convert_date(date){
    var day = "";
    switch(date){
        case 0: day = "Mon-Tue"; break;
        case 1: day = "Tue-Wed"; break;
        case 2: day = "Wed-Thu"; break;
        case 3: day = "Thu-Fri"; break;
        case 4: day = "Fri-Sat"; break;
        case 5: day = "Sat-Sun"; break;
        case 6: day = "Sun-Mon"; break;
        case "0": day = "Mon-Tue"; break;
        case "1": day = "Tue-Wed"; break;
        case "2": day = "Wed-Thu"; break;
        case "3": day = "Thu-Fri"; break;
