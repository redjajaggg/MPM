const data_csv_format = "https://docs.google.com/spreadsheets/d/1U0F2QEFHx1vDufEJhb4_Pg_li0QgQHp6JtPRzlKOAAE/export?format=csv";
...
function appenddata(data){
    ...
    function getinfolink(datai){
        ...
        if(data[i].Convey == false){document.getElementById("content").innerHTML = data[i].Name + " <br>is Not Availiable."; document.getElementById("chapter").innerHTML = "Chapter is Not Availiable."; document.getElementById("allchap").innerHTML = "Chapter is Not Availiable.";}
